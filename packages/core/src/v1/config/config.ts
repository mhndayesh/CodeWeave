...
export const Info = Schema.Struct({
  ...
  liveContextCompiler: Schema.optional(
    Schema.Struct({
      ignorePatterns: Schema.optional(Schema.mutable(Schema.Array(Schema.String))),
      defaultMaxTokens: Schema.optional(PositiveInt).annotate({
  ...
  ).annotate({ description: "Live Context Compiler configuration (fork-specific)" }),
