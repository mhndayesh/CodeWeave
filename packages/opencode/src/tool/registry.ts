...
import { ContextCompileTool, ContextExpandTool, ContextStatusTool } from "./live-context"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const contextCompile = yield* ContextCompileTool
    const contextExpand = yield* ContextExpandTool
    const contextStatus = yield* ContextStatusTool
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const tool = yield* Effect.all({
          ...
          contextCompile: Tool.init(contextCompile),
          contextExpand: Tool.init(contextExpand),
          contextStatus: Tool.init(contextStatus),
          plan: Tool.init(plan),
        })
